        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Update0n = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Createdo0n = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    IsAppoved = table.Column<bool>(type: "boolean", nullable: false),
                    Approvedo0n = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AdminFee = table.Column<decimal>(type: "numeric", nullable: false),
                    KtpPath = table.Column<string>(type: "text", nullable: true),
                    KkpPath = table.Column<string>(type: "text", nullable: true),
